...
const SOURCES = {
  ...
  azure_architecture_blog: {
    ...
    url: "https://techcommunity.microsoft.com/category/azure/blog/azurearchitectureblog",
    mandatory: true,
    type: "techcommunity",
  },
  azure_infrastructure_blog: {
    name: "Azure Infrastructure Blog",
    url: "https://techcommunity.microsoft.com/category/azure/blog/azureinfrastructureblog",
    mandatory: true,
    type: "techcommunity",
  },
  linux_opensource_blog: {
    name: "Linux and Open Source Blog",
    url: "https://techcommunity.microsoft.com/category/azure/blog/linuxandopensourceblog",
    mandatory: true,
    type: "techcommunity",
  },
  apps_on_azure_blog: {
    name: "Apps on Azure Blog",
    url: "https://techcommunity.microsoft.com/category/azure/blog/appsonazureblog",
    mandatory: true,
    type: "techcommunity",
  },
  azure_observability_blog: {
    name: "Azure Observability Blog",
    url: "https://techcommunity.microsoft.com/category/azure/blog/azureobservabilityblog",
    mandatory: true,
    type: "techcommunity",
  },
  aks_youtube: {
